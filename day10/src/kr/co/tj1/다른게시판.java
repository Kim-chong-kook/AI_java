...
ArrayList<HashMap<String, Object>> boardTable = new ArrayList<>(); // 객체 1회선언과 생성
...
private void update(HashMap<String, Object> board) {
	Scanner scan = new Scanner(System.in);
	System.out.print("제목>");
	board.put("TITLE", scan.nextLine());
	System.out.print("내용>");
	board.put("CONTENT", scan.nextLine());
...
private void insert() {
	...
	board.put("USER_NAME", scan.nextLine());
