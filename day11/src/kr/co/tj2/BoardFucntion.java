...
public class BoardFucntion {
	...
	// 검색
	public static void search(String serchTitle, Scanner scan, ArrayList<HashMap<String,String>>boardList) {
	...
	// 업데이트
	public static void update(String updateTitle, String titleContent, int indexI, String title, String content,Scanner scan, ArrayList<HashMap<String,String>>boardList) {
